...
/*
 * TRACE
 * print_text("pdev->regs=");
 * print_hex((uint32_t)pdev->regs.GREGS);
 * print_text(" pdev->regs.HC_REGS[hc_num]=");
 * print_hex((uint32_t)pdev->regs.HC_REGS[hc_num]);
 * print_text(" hcchar.b.devaddr=");
 * print_number(hcchar.b.devaddr);
 * print_lf();
 */
 ...
 * TRACE
 * print_text("xfer_len=");
 * print_number(pdev->host.hc[hc_num].xfer_len);
 * print_lf();
 */
 ...
 * print_number(hc_num);
 * print_number(pdev->host.hc[hc_num].xfer_len);
 * print_number(num_packets);
 * print_hex(pdev->host.hc[hc_num].data_pid);
 * print_lf();
 */
