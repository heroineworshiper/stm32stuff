...
// Lidar Lite needs a stable clock source
//#ifdef USE_LIDAR
//#define PLL_M      2
//#else
...
/* AHB bus divider no max.  source is system clock */
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;

/* PCLK2 divider max 84Mhz. source is AHB clock */
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;

/* PCLK1 divider max 42Mhz. source is AHB clock */
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;

    RCC->CFGR |= RCC_CR_HSEBYP;
...
// Configuration with internal oscillator source
// Trimming
